...
function custom_post_example() { 
	...
	register_post_type( 'custom_type', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 'labels' => array(
			...
			'singular_name' => __( 'Staff Post', 'bonestheme' ), /* This is the individual type */
			'all_items' => __( 'All Staff Posts', 'bonestheme' ), /* the all items menu item */
			'add_new' => __( 'Add New', 'bonestheme' ), /* The add new menu item */
			'add_new_item' => __( 'Add New Staff Type', 'bonestheme' ), /* Add New Display Title */
	...
	*/
	...
	register_taxonomy( 'custom_tag', 
		...
		array('hierarchical' => false,    /* if this is false, it acts like tags */
			'labels' => array(
				'name' => __( 'Staff Tags', 'bonestheme' ), /* name of the custom taxonomy */
				'singular_name' => __( 'Staff Tag', 'bonestheme' ), /* single taxonomy name */
				'search_items' =>  __( 'Search Staff Tags', 'bonestheme' ), /* search title for taxomony */
				'all_items' => __( 'All Staff Tags', 'bonestheme' ), /* all title for taxonomies */
				'parent_item' => __( 'Parent Staff Tag', 'bonestheme' ), /* parent title for taxonomy */
				'parent_item_colon' => __( 'Parent Staff Tag:', 'bonestheme' ), /* parent taxonomy title */
				'edit_item' => __( 'Edit Staff Tag', 'bonestheme' ), /* edit custom taxonomy title */
				'update_item' => __( 'Update Staff Tag', 'bonestheme' ), /* update title for taxonomy */
				'add_new_item' => __( 'Add New Staff Tag', 'bonestheme' ), /* add new title for taxonomy */
				'new_item_name' => __( 'New Staff Tag Name', 'bonestheme' ) /* name title for taxonomy */
			),
			'show_admin_column' => true,
			'show_ui' => true,
			'query_var' => true,
